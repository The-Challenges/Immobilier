  ...
  useEffect(() => {
    ...
    socketserv.on('requestLandCreated', (data) => {
      if(data) {
        ...
        console.log('requestLandCreated datat from server requestLandCreated datat from serverrequestLandCreated datat from serverrequestLandCreated datat from serverrequestLandCreated datat from serverrequestLandCreated datat from serverrequestLandCreated datat from serverrequestLandCreated datat from serverrequestLandCreated datat from server', data);
      }
