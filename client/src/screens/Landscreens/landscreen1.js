...
import Screen1 from './landsceen2';
// import Screen3 from '../housescreen/housescren3';

function Screen3({ formData, handleChange, handleLocationSelection, navigateToNext }) {
