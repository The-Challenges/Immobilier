...
const HomeScreen = ({ navigation }) => {
    ...
    const ListOptions = () => {
        const optionsList = [
            { title: 'See all houses', img: require('../assets/villa.jpg'), action: () => navigation.navigate('SeeAllHouses') },
            { title: 'See all lands', img: require('../assets/land2.jpg'), action: () => navigation.navigate('SeeAllLands') },
        ];
        return (
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
            ...
            <View style={styles.header}>
                <View style={styles.searchInputContainer}>
                    ...
                    <TextInput placeholder="Search address, city, location" placeholderTextColor="#888" style={{ flex: 1 }} />
                </View>
